...
class BackToTheFutureSpec extends Specification implements UnitClockSupport {
    ...
    def "Back to the Future"() {
        ...
        println("Base Time: " + localDate())
        println("Marty travels to 1955\n")

        setClockTo(midnightOf(LocalDate.of(1955, 11, 5)))
        println("Time Travel: " + localDate())
        println("Marty meets young Doc\n") // Explanation

        setClockTo(midnightOf(LocalDate.of(1955, 11, 12)))
        println("Enchantment Under the Sea Dance: " + localDate())
        println("Marty saves his parents\n") // Explanation

        setClockTo(midnightOf(LocalDate.of(2015, 10, 21)))
        println("Future: " + localDate())
        println("Marty and Doc arrive\n")

        setClockTo(midnightOf(LocalDate.of(1885, 1, 1)))
        println("Wild West: " + localDate())
        println("Marty rescues Doc\n")
